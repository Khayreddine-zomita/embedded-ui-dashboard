...
lv_obj_t * screen_sensors_create(void)
{
    ...
    lv_obj_t * sensors_screen_card_2 = sensors_screen_card_create(lv_obj_0, "WATER TEMP", "22.3", "Â°C", 66, "Optimal", "Target 18 - 23 C", COLOR_STATUS_INFO, "48 52 50 55 53 58 56 62", 40, 80);
    lv_obj_set_x(sensors_screen_card_2, 322);
    lv_obj_set_y(sensors_screen_card_2, 52);

    lv_obj_t * sensors_screen_card_3 = sensors_screen_card_create(lv_obj_0, "AIR TEMP", "23.0", "Â°C", 66, "Good", "Target 16 - 24 C", COLOR_STATUS_CRITICAL, "50 53 52 56 54 58 57 61", 40, 80);
    lv_obj_set_x(sensors_screen_card_3, 8);
    lv_obj_set_y(sensors_screen_card_3, 164);

    lv_obj_t * sensors_screen_card_4 = sensors_screen_card_create(lv_obj_0, "HUMIDITY", "71", "%", 36, "Good", "Target 80 - 99%", COLOR_PURPLE, "52 55 54 58 57 61 59 64", 40, 80);
