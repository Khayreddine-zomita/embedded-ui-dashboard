...
lv_obj_t * led_edit_settings_button_card_create(lv_obj_t * parent, const char * button_text)
{
    ...
    lv_obj_set_style_border_color(led_edit_settings_btn, COLOR_STATUS_CRITICAL, 0);
    ...
    lv_obj_set_y(led_edit_settings_label, 9);
    ...
    lv_obj_set_style_text_color(led_edit_settings_label, COLOR_STATUS_CRITICAL, 0);
